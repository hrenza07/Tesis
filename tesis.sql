...
-- Started on 2015-05-23 10:11:53
...
--
-- TOC entry 2264 (class 0 OID 17675)
-- Dependencies: 173
-- Data for Name: bono; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY bono ("idBono", fecha, "idTipoBono", "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 174
-- Name: bono_idBono_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"bono_idBono_seq"', 1, false);


--
-- TOC entry 2266 (class 0 OID 17680)
-- Dependencies: 175
-- Data for Name: capacitacion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY capacitacion ("idCapacitacion", nombre, descripcion, lugar, fecha_inicio, fecha_fin, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 176
-- Name: capacitacion_idCapacitacion_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"capacitacion_idCapacitacion_seq"', 1, false);


--
-- TOC entry 2268 (class 0 OID 17688)
-- Dependencies: 177
-- Data for Name: contrato; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY contrato ("idContrato", "idEmpleado", "idTipoContrato", fecha_inicio, fecha_fin) FROM stdin;
\.
...
-- Dependencies: 178
-- Name: contrato_idContrato_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"contrato_idContrato_seq"', 1, false);


--
-- TOC entry 2270 (class 0 OID 17693)
-- Dependencies: 179
-- Data for Name: correo; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY correo ("idCorreo", correo, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 180
-- Name: correo_idCorreo_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"correo_idCorreo_seq"', 1, false);


--
-- TOC entry 2272 (class 0 OID 17701)
-- Dependencies: 181
-- Data for Name: criterio; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY criterio ("idCriterio", descripcion, peso, "idPuesto") FROM stdin;
\.
...
-- Dependencies: 182
-- Name: criterio_idCriterio_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"criterio_idCriterio_seq"', 1, false);


--
-- TOC entry 2274 (class 0 OID 17709)
-- Dependencies: 183
-- Data for Name: departamento; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY departamento (id_departamento, nombre, descripcion) FROM stdin;
41	Recursos Humano	Velar por el personal en la Instittucion
\.
...
-- Dependencies: 184
-- Name: departamento_idepartamento_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('departamento_idepartamento_seq', 44, true);


--
-- TOC entry 2276 (class 0 OID 17717)
-- Dependencies: 185
-- Data for Name: descuento; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY descuento ("idDescuento", fecha, "idTipoDescuento", "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 186
-- Name: descuento_idDescuento_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"descuento_idDescuento_seq"', 1, false);


--
-- TOC entry 2278 (class 0 OID 17722)
-- Dependencies: 187
-- Data for Name: educacion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY educacion ("idEducacion", titulo, fecha, "idEmpleado", lugar, institucion, idx, nivel) FROM stdin;
\.
...
-- Dependencies: 188
-- Name: educacion_educacion_seqid; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('educacion_educacion_seqid', 10, true);


--
-- TOC entry 2280 (class 0 OID 17730)
-- Dependencies: 189
-- Data for Name: empleado; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY empleado (empleado_id, dui, isss, afp, sexo, id_departamento, nit, nombre, apellido, cuenta, salario, "id_PuestoTrabajo", edad, estado_civil, id_manager) FROM stdin;
\.
...
-- Dependencies: 190
-- Name: empleado_empleado_idseq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('empleado_empleado_idseq', 13, true);


--
-- TOC entry 2371 (class 0 OID 0)
-- Dependencies: 223
-- Name: empleado_id_manager_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('empleado_id_manager_seq', 1, false);


--
-- TOC entry 2282 (class 0 OID 17738)
-- Dependencies: 191
-- Data for Name: evaluacion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY evaluacion ("idEvaluacion", puntaje, fecha, "idEmpleado", "idCriterio") FROM stdin;
\.
...
-- Dependencies: 192
-- Name: evaluacion_idEvaluacion_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"evaluacion_idEvaluacion_seq"', 1, false);


--
-- TOC entry 2313 (class 0 OID 18085)
-- Dependencies: 222
-- Data for Name: exp_laboral; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY exp_laboral (lugar, tiempo, cargo, id_explaboral, "idEmpleado", idx) FROM stdin;
\.
...
-- Dependencies: 221
-- Name: exp_laboral_id_explaboral_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('exp_laboral_id_explaboral_seq', 9, true);


--
-- TOC entry 2374 (class 0 OID 0)
-- Dependencies: 225
-- Name: obj_departamento_id_objetivodep_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('obj_departamento_id_objetivodep_seq', 145, true);


--
-- TOC entry 2315 (class 0 OID 18134)
-- Dependencies: 224
-- Data for Name: objdepartamento; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY objdepartamento (tipo, descripcion, id_objetivodep, id_departamento, idx) FROM stdin;
Primario	reglamento Institucional	132	\N	\N
Primario	planilla empleados	131	41	2
Primario	Gestionar Relaciones personales	133	41	3
\.


--
-- TOC entry 2284 (class 0 OID 17743)
-- Dependencies: 193
-- Data for Name: objetivo; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY objetivo ("idObjetivo", descripcion, alcance, "idPuestoTrabajo") FROM stdin;
\.
...
-- Dependencies: 194
-- Name: objetivo_idObjetivo_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"objetivo_idObjetivo_seq"', 1, false);


--
-- TOC entry 2286 (class 0 OID 17751)
-- Dependencies: 195
-- Data for Name: permiso; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY permiso ("idPermiso", remunerado, inicio, fin, "idEmpleado", "idTipoPermiso") FROM stdin;
\.
...
-- Dependencies: 196
-- Name: permiso_idPermiso_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--
...
--
-- TOC entry 2288 (class 0 OID 17756)
-- Dependencies: 197
-- Data for Name: planilla; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY planilla ("idPlanilla", fecha_inicio, fecha_fin, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 198
-- Name: planilla_idPlanilla_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"planilla_idPlanilla_seq"', 1, false);


--
-- TOC entry 2290 (class 0 OID 17761)
-- Dependencies: 199
-- Data for Name: puesto_historico; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY puesto_historico ("idHistoricoPuesto", "idPuesto", "idEmpleado", fecha_inicio, fecha_fin) FROM stdin;
\.
...
-- Dependencies: 200
-- Name: puesto_historico_idHistoricoPuesto_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"puesto_historico_idHistoricoPuesto_seq"', 1, false);


--
-- TOC entry 2292 (class 0 OID 17766)
-- Dependencies: 201
-- Data for Name: puesto_trabajo; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY puesto_trabajo ("idPuestoTrabajo", nombre, descripcion, salario_max, salario_min) FROM stdin;
\.
...
-- Dependencies: 202
-- Name: puesto_trabajo_idpuestotrabajo_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('puesto_trabajo_idpuestotrabajo_seq', 1, false);


--
-- TOC entry 2294 (class 0 OID 17774)
-- Dependencies: 203
-- Data for Name: reconocimiento; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY reconocimiento ("idReconocimiento", descripcion, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 204
-- Name: reconocimiento_idReconocimiento_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"reconocimiento_idReconocimiento_seq"', 1, false);


--
-- TOC entry 2296 (class 0 OID 17782)
-- Dependencies: 205
-- Data for Name: sancion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY sancion ("idSancion", gravedad, descripcion, fecha, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 206
-- Name: sancion_idSancion_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"sancion_idSancion_seq"', 1, false);


--
-- TOC entry 2298 (class 0 OID 17790)
-- Dependencies: 207
-- Data for Name: telefono; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY telefono ("idTelefono", telefono, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 208
-- Name: telefono_idTelefono_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"telefono_idTelefono_seq"', 1, false);


--
-- TOC entry 2300 (class 0 OID 17798)
-- Dependencies: 209
-- Data for Name: tipo_bono; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY tipo_bono ("idTipoBono", "idPuesto", porcentaje) FROM stdin;
\.
...
-- Dependencies: 210
-- Name: tipo_bono_idTipoBono_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"tipo_bono_idTipoBono_seq"', 1, false);


--
-- TOC entry 2302 (class 0 OID 17803)
-- Dependencies: 211
-- Data for Name: tipo_contrato; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY tipo_contrato ("idTipoContrato", descripcion) FROM stdin;
\.
...
-- Dependencies: 212
-- Name: tipo_contrato_idTipoContrato_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"tipo_contrato_idTipoContrato_seq"', 1, false);


--
-- TOC entry 2304 (class 0 OID 17811)
-- Dependencies: 213
-- Data for Name: tipo_descuento; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY tipo_descuento ("idTipoDescuento", descripcion, porcentaje) FROM stdin;
\.
...
-- Dependencies: 214
-- Name: tipo_descuento_idTipoDescuento_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"tipo_descuento_idTipoDescuento_seq"', 1, false);


--
-- TOC entry 2306 (class 0 OID 17819)
-- Dependencies: 215
-- Data for Name: tipo_permiso; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY tipo_permiso ("idTipoPermiso", descripcion) FROM stdin;
\.
...
-- Dependencies: 216
-- Name: tipo_permiso_idTipoPermiso_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"tipo_permiso_idTipoPermiso_seq"', 1, false);


--
-- TOC entry 2308 (class 0 OID 17827)
-- Dependencies: 217
-- Data for Name: transaccion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY transaccion ("idTransaccion", "idEmpleado", credito_debito, monto, fecha) FROM stdin;
\.
...
-- Dependencies: 218
-- Name: transaccion_idTransaccion_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"transaccion_idTransaccion_seq"', 1, false);


--
-- TOC entry 2310 (class 0 OID 17832)
-- Dependencies: 219
-- Data for Name: vacacion; Type: TABLE DATA; Schema: pribantsa; Owner: postgres
--

COPY vacacion ("idVacacion", fecha_inicio, fecha_fin, "idEmpleado") FROM stdin;
\.
...
-- Dependencies: 220
-- Name: vacacion_idVacacion_seq; Type: SEQUENCE SET; Schema: pribantsa; Owner: postgres
--

SELECT pg_catalog.setval('"vacacion_idVacacion_seq"', 1, false);
...
GRANT INSERT ON TABLE empleado TO byron;
...
-- Completed on 2015-05-23 10:11:54
